...
class CategoryService:
    ...
    def create_category(self, category_create: CategoryCreateSchema) -> CategorySchema:
        category_orm = self.category_repository.create_category(
    ...
    def update_category(
        ...
        category_for_update = self.category_repository.get_id_category(
    ...
    def delete_category(self, category_id: str):
        category_for_delete = self.category_repository.get_id_category(
            category_id=category_id
        )
